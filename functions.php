...
function practical_setup() {
	...
	register_nav_menus(
		array(
			'left-menu' => esc_html__( 'Left Menu', 'practical' ),
			'right-menu' => esc_html__( 'Right Menu', 'practical' ),
		),
	);
...
function practical_scripts() {
	wp_enqueue_style( 'practical-style', get_stylesheet_uri(), array(), time() );
	...
	wp_enqueue_script( 'practical-custom-script', get_template_directory_uri() . '/js/custom-script.js', array(), time(), true );
